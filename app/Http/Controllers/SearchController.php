...
//print_r($menuitems);
		...
		return view('search', compact("categories", "localities", "relatedtreatments", "venueArr", "rating", "menuitems", "venuepicarr"));

	}

	public function filtertreatment($city, $treatment, $location, $service, $sortby)
	{
